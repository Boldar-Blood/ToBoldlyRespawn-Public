...
def _make_icon_from_title(title_banner: Path, icon_png: Path, icon_ico: Path) -> None:
    ...
    # Small flight vector mark ties the taskbar/shortcut icon to the game art at tiny sizes.
    draw.polygon(
        [(256, 372), (334, 454), (256, 424), (178, 454)],
        fill=(0, 200, 255, 230),
        outline=(210, 255, 255, 255),
    )
...
def _make_startup_splash(title_banner: Path, splash_image: Path) -> None:
    ...
    splash = Image.new("RGBA", (1280, 720), (1, 5, 15, 255))
