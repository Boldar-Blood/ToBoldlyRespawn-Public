...
class StoryPopupAdvanceResult:
    ...
    @property
    def popup_state(self) -> Optional[StoryPopupState]:
        """Backward-compatible alias for older UI integration code."""
...
class StoryPopupController:
    ...
    def advance(
        ...
        **_unused_context,
        ...
        Extra keyword context is accepted and ignored so presentation integration
        code cannot break the pure controller by passing nonessential runtime
        objects such as the game-state manager.
        """
