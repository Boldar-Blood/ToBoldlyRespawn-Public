...
from space_demo.ui.autofit import apply_screen_widget_autofit
...
class SpaceDisasterApp(BaseSpaceDisasterApp):
    ...
    def __init__(
        ...
        if not self.headless and getattr(self, "screens", None) is not None:
            apply_screen_widget_autofit(self.screens)
