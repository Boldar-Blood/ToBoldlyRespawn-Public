...
DREADNOUGHT_GAIN_RATE = 3.0 # Gap decreases by 3.0 units per second
DREADNOUGHT_PUSH_BACK = 12.0 # Defeating/damaging engines pushes it back by 12 units
DREADNOUGHT_NON_BOSS_PUSHBACK_MULT = 0.255
DREADNOUGHT_CRITICAL_GAP = 100.0 # Proximity alarm activates below this threshold
